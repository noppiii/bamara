                                ...
                                <ul>
                                    <li class="has-dropdown has-homemenu">
                                        ...
                                        <ul class="sub-menu home-menu-style">
                                            <li>
                                                <a href="index.html"><img src="{{asset('client/assets/img/header/home1-1.jpg')}}" alt=""> Home Page V1</a>
                                            </li>
                                            <li>
                                                <a href="index-2.html"><img src="{{asset('client/assets/img/header/home2-1.jpg')}}" alt=""> Home Page V2</a>
                                            </li>
                                            <li>
                                                <a href="index-3.html"><img src="{{asset('client/assets/img/header/home3-1.jpg')}}" alt=""> Home Page V3</a>
                                            </li>
                                            <li>
                                                <a href="index-4.html"><img src="{{asset('client/assets/img/header/home4-1.jpg')}}" alt=""> Home Page V4</a>
                                            </li>
                                            <li>
                                                <a href="index-5.html"><img src="{{asset('client/assets/img/header/home5-1.jpg')}}" alt=""> Home Page V5</a>
                                            </li>
                                            <li>
                                                <a href="index-6.html"><img src="{{asset('client/assets/img/header/home6-1.jpg')}}" alt=""> Home Page V6</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="has-dropdown has-megamenu" >
                                        <a href="course-grid.html">Shop</a>
                                        <ul class="sub-menu mega-menu" data-background="{{asset('client/assets/img/banner/mega-menu-shop-1.jpg')}}">
                                            <li>
