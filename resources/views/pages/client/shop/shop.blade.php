...
@section('content')
    <main>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-10 col-lg-12 col-md-12">
                        <div class="tpshop__top ml-60">
                            <div class="tpshop__banner mb-30" data-background="{{asset('client/assets/img/banner/shop-bg-10.jpg')}}">
                                    ...
                                    <div class="row row-cols-xxl-4 row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-sm-2 row-cols-1 tpproduct__shop-item">
                                        <div class="col">
                                            <div class="tpproduct p-relative mb-20">
                                                <div class="tpproduct__thumb p-relative text-center">
                                                    <a href="#"><img src="{{asset('client/assets/img/product/products21-min.jpg')}}" alt=""></a>
                                                    <a class="tpproduct__thumb-img" href="shop-details-grid.html"><img src="{{asset('client/assets/img/product/products1-min.jpg')}}" alt=""></a>
                                        ...
                                        <div class="col">
                                            <div class="tpproduct p-relative">
                                                <div class="tpproduct__thumb p-relative text-center">
                                                    <a href="#"><img src="{{asset('client/assets/img/product/products22-min.jpg')}}" alt=""></a>
                                                    <a class="tpproduct__thumb-img" href="shop-details-grid.html"><img src="{{asset('client/assets/img/product/products11-min.jpg')}}" alt=""></a>
                                                    <div class="tpproduct__info bage">
                                        ...
                                        <div class="col">
                                            <div class="tpproduct p-relative">
                                                <div class="tpproduct__thumb p-relative text-center">
                                                    <a href="#"><img src="{{asset('client/assets/img/product/products4-min.jpg')}}" alt=""></a>
                                                    <a class="tpproduct__thumb-img" href="shop-details-grid.html"><img src="{{asset('client/assets/img/product/products23-min.jpg')}}" alt=""></a>
                                                    <div class="tpproduct__info bage">
                                        ...
                                        <div class="col">
                                            <div class="tpproduct p-relative">
                                                <div class="tpproduct__thumb p-relative text-center">
                                                    <a href="#"><img src="{{asset('client/assets/img/product/products27-min.jpg')}}" alt=""></a>
                                                    <a class="tpproduct__thumb-img" href="shop-details.html"><img src="{{asset('client/assets/img/product/products14-min.jpg')}}" alt=""></a>
                                                    <div class="tpproduct__info bage">
                                        ...
                                        <div class="col">
                                            <div class="tpproduct p-relative">
                                                <div class="tpproduct__thumb p-relative text-center">
                                                    <a href="#"><img src="{{asset('client/assets/img/product/products16-min.jpg')}}" alt=""></a>
                                                    <a class="tpproduct__thumb-img" href="shop-details-grid.html"><img src="{{asset('client/assets/img/product/products11-min.jpg')}}" alt=""></a>
                                                    <div class="tpproduct__info bage">
                                                        <span class="tpproduct__info-discount bage__discount">-50%</span>
                                                    </div>
                                        ...
                                        <div class="col">
                                            <div class="tpproduct p-relative">
                                                <div class="tpproduct__thumb p-relative text-center">
                                                    <a href="#"><img src="{{asset('client/assets/img/product/products17-min.jpg')}}" alt=""></a>
                                                    <a class="tpproduct__thumb-img" href="shop-details-grid.html"><img src="{{asset('client/assets/img/product/products37-min.jpg')}}" alt=""></a>
                                                    <div class="tpproduct__info bage">
                                                        <span class="tpproduct__info-discount bage__discount">-40%</span>
                                                        <span class="tpproduct__info-hot bage__hot">HOT</span>
                                                    </div>
                                        ...
                                        <div class="col">
                                            <div class="tpproduct p-relative mb-20">
                                                <div class="tpproduct__thumb p-relative text-center">
                                                    <a href="#"><img src="{{asset('client/assets/img/product/products29-min.jpg')}}" alt=""></a>
                                                    <a class="tpproduct__thumb-img" href="shop-details.html"><img src="{{asset('client/assets/img/product/products30-min.jpg')}}" alt=""></a>
                                                    <div class="tpproduct__info bage">
                                                        <span class="tpproduct__info-discount bage__discount">-50%</span>
                                                        <span class="tpproduct__info-hot bage__hot">HOT</span>
                                                    </div>
                                        ...
                                        <div class="col">
                                            <div class="tpproduct p-relative">
                                                <div class="tpproduct__thumb p-relative text-center">
                                                    <a href="#"><img src="{{asset('client/assets/img/product/products9-min.jpg')}}" alt=""></a>
                                                    <a class="tpproduct__thumb-img" href="shop-details.html"><img src="{{asset('client/assets/img/product/products10-min.jpg')}}" alt=""></a>
                                                    <div class="tpproduct__info bage">
                                                        <span class="tpproduct__info-discount bage__discount">-40%</span>
                                                    </div>
                                                    <div class="tpproduct__shopping">
                                        ...
                                        <div class="col">
                                            <div class="tpproduct p-relative">
                                                <div class="tpproduct__thumb p-relative text-center">
                                                    <a href="#"><img src="{{asset('client/assets/img/product/products13-min.jpg')}}" alt=""></a>
                                                    <a class="tpproduct__thumb-img" href="shop-details.html"><img src="{{asset('client/assets/img/product/products35-min.jpg')}}" alt=""></a>
                                                    <div class="tpproduct__info bage">
                                                        <span class="tpproduct__info-discount bage__discount">-10%</span>
                                                    </div>
                                                    <div class="tpproduct__shopping">
                                        ...
                                        <div class="col">
                                            <div class="tpproduct p-relative">
                                                <div class="tpproduct__thumb p-relative text-center">
                                                    <a href="#"><img src="{{asset('client/assets/img/product/products15-min.jpg')}}" alt=""></a>
                                                    <a class="tpproduct__thumb-img" href="shop-details.html"><img src="{{asset('client/assets/img/product/products32-min.jpg')}}" alt=""></a>
                                                    <div class="tpproduct__info bage">
                                                        <span class="tpproduct__info-discount bage__discount">-50%</span>
                                                    </div>
                                                    <div class="tpproduct__shopping">
        ...
        <!-- feature-area-start -->
        <section class="feature-area mainfeature__bg grey-bg pt-50 pb-40" data-background="{{asset('client/assets/img/shape/footer-shape-1.svg')}}">
            <div class="container">
